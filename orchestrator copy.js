...
const { memoryAgent, getMemoryState, clearMemoryState } = require("./agents/memory");
...
const { EvolutionEngine } = require("./agents/evolutionEngine");

// Singleton instances for context awareness and learning
