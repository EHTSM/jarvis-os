...
**§7.4 matters.** Only 6 of 35 executed audits produced weighted dimension scores; the rest were pass/fail against defined criteria. Averaging across both would fabricate precision.
