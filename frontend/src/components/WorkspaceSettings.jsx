...
const HEALTH_COLOR = { ok: "#52d68a", degraded: "var(--warning)", error: "var(--error)", unknown: "var(--text-faint)" };
const DIAG_COLOR   = { info: "var(--accent)", warn: "var(--warning)", error: "var(--error)" };
