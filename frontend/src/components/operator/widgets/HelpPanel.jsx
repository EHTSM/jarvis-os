    ...
    sections: [
      {
        ...
        content: [
          "The yellow reconnecting banner means Ooplix lost its live connection. This is normal after sleep/wake or network changes.",
          "Wait up to 60 seconds — Ooplix reconnects automatically with exponential backoff.",
      ...
      <div className="op-help-card" onClick={e => e.stopPropagation()}>
        ...
        <div className="op-help-header">
          <div className="op-help-title-row">
            <span className="op-help-title">Ooplix Help</span>
