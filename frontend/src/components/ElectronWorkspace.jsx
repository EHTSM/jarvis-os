...
const ContentSEO                  = lazy(() => import('./ContentSEO'));
const DistributionOS              = lazy(() => import('./DistributionOS'));
const RevenueOS                   = lazy(() => import('./RevenueOS'));
...
const ProductionWiring            = lazy(() => import('./ProductionWiring'));
const ProductionWiring2           = lazy(() => import('./ProductionWiring2'));
...
const BOTTOM_TABS = {
  ...
  'content-seo': { label: 'Content',  icon: '✦' },
  'distrib':     { label: 'Distribute', icon: '◎' },
  ...
  'prod-wiring':   { label: 'Wiring',        icon: '⚡' },
  'prod-wiring2':  { label: 'Wiring 2',      icon: '⚡' },
            ...
            <>
              ...
              <div className="ew-bottom" style={{ height: bottomH, flexShrink: 0 }}>
                ...
                <div className="ew-bottom__body">
                  ...
                  <LazyPane active={bottomTab === 'launch'}>
                    <ErrorBoundary label="Launch Platform"><LaunchPlatform /></ErrorBoundary>
                  </LazyPane>
                  ...
                  <LazyPane active={bottomTab === 'content-seo'}>
                    <ErrorBoundary label="Content SEO"><ContentSEO /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'distrib'}>
                    <ErrorBoundary label="Distribution OS"><DistributionOS /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'revenue'}>
                    <ErrorBoundary label="Revenue OS"><RevenueOS /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'prod-ops'}>
                    <ErrorBoundary label="Production Ops"><ProductionOps /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'founder-ops'}>
                    <ErrorBoundary label="Founder Ops"><FounderOps /></ErrorBoundary>
                  </LazyPane>
                  ...
                  <LazyPane active={bottomTab === 'prod-wiring'}>
                    <ErrorBoundary label="Production Wiring"><ProductionWiring /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'prod-wiring2'}>
                    <ErrorBoundary label="Production Wiring 2"><ProductionWiring2 /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'credentials'}>
                    <ErrorBoundary label="Credentials"><CredentialDashboard /></ErrorBoundary>
                  </LazyPane>
                  <LazyPane active={bottomTab === 'ext-platforms'}>
                    <ErrorBoundary label="External Platforms"><ExternalPlatformDashboard /></ErrorBoundary>
                  </LazyPane>
