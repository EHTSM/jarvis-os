...
const _st    = () => _try(() => require("../services/autonomousState.cjs"));
const _lp    = () => _try(() => require("../services/autonomousLoop.cjs"));
const _org   = () => _try(() => require("../services/autonomousOrg.cjs"));
