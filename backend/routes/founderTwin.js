...
// `router.use("/twin", requireAuth)` gate before mounting this file. Now
// pointing at the real module/export, with a fail-closed fallback (403,
// not next()) if it were ever somehow still unavailable.
