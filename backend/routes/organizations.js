...
// ── Members ───────────────────────────────────────────────────────────────────
router.get("/orgs/:orgId/members", (req, res) => {
    try {
...
router.patch("/orgs/:orgId/members/:accountId", (req, res) => {
    try {
...
router.delete("/orgs/:orgId/members/:accountId", (req, res) => {
    try {
...
// ── Departments ───────────────────────────────────────────────────────────────
router.get("/orgs/:orgId/departments", (req, res) => {
    try { _ok(res, _svc().listDepartments(req.params.orgId)); }
    catch (e) { _err(res, e); }
});

router.post("/orgs/:orgId/departments", (req, res) => {
    try {
...
router.patch("/orgs/:orgId/departments/:deptId", (req, res) => {
    try {
        _ok(res, { department: _svc().updateDepartment(req.params.orgId, req.params.deptId, req.body || {}, req.user.sub) });
    } catch (e) { _err(res, e, 400); }
});

router.delete("/orgs/:orgId/departments/:deptId", (req, res) => {
    try {
...
router.get("/orgs/:orgId/departments/:deptId/teams", (req, res) => {
    try { _ok(res, _svc().listTeams(req.params.orgId, req.params.deptId)); }
    catch (e) { _err(res, e); }
});

router.post("/orgs/:orgId/departments/:deptId/teams", (req, res) => {
    try {
        const { name, description, leadAccountId } = req.body || {};
...
router.patch("/orgs/:orgId/departments/:deptId/teams/:teamId", (req, res) => {
    try {
        _ok(res, { team: _svc().updateTeam(req.params.orgId, req.params.deptId, req.params.teamId, req.body || {}, req.user.sub) });
    } catch (e) { _err(res, e, 400); }
});

router.delete("/orgs/:orgId/departments/:deptId/teams/:teamId", (req, res) => {
    try {
        _ok(res, _svc().deleteTeam(req.params.orgId, req.params.deptId, req.params.teamId, req.user.sub));
    } catch (e) { _err(res, e, 400); }
});

router.post("/orgs/:orgId/departments/:deptId/teams/:teamId/members", (req, res) => {
    try {
...
router.delete("/orgs/:orgId/departments/:deptId/teams/:teamId/members/:accountId", (req, res) => {
    try {
...
// ── Org-scoped missions ───────────────────────────────────────────────────────
router.post("/orgs/:orgId/missions", (req, res) => {
    try {
...
router.get("/orgs/:orgId/missions", (req, res) => {
    try {
...
router.get("/orgs/:orgId/missions/:missionId/ownership", (req, res) => {
    try {
