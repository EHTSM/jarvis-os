...
const TEMPLATES = {
    ...
    hr_recruitment: {
        ...
        kpis: [],
        requiresNewCapability: true,
        note: "Confirmed no working implementation — agents/executor.cjs references a nonexistent \"hrManagementAgent\"/\"recruitmentAgent\" via the disconnected agents/multi/agentExecutor.cjs registry (dead-end, empirically verified).",
    },
    procurement: {
        label: "Procurement",
        requiredCapabilities: [],
