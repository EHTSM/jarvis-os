...
| B17 | Electron installer (DMG/EXE/AppImage) — production status unproven; see Phase 4 of this mission for root-cause investigation | CODE / INFRASTRUCTURE (determined in Phase 4 below) | TBD — see Phase 4 findings | TBD | This document, Phase 4 section |
